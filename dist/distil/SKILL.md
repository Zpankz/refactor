---
name: rlm-ralph-loop-multi-agent-orchestration
...
- `/Users/mikhail/Projects/Context-Engineering/Distil/rlm-ralph-loop-multi-agent-orchestration/scripts/rlm_orchestrator.py`
...
- `/Users/mikhail/Projects/Context-Engineering/Distil/rlm-ralph-loop-multi-agent-orchestration/scripts/rlm_orchestrator.py` is the implementation core.
- `/Users/mikhail/Projects/Context-Engineering/Distil/rlm-ralph-loop-multi-agent-orchestration/references/process-model.md` explains the conceptual mapping.
- `/Users/mikhail/Projects/Context-Engineering/Distil/rlm-ralph-loop-multi-agent-orchestration/references/ulcb1-tree-search.md` explains recursive stopping criteria.
...
- `/Users/mikhail/Projects/Context-Engineering/Distil/rlm-ralph-loop-multi-agent-orchestration/references/ontology-schema.md` for schema details.
- `/Users/mikhail/Projects/Context-Engineering/Distil/rlm-ralph-loop-multi-agent-orchestration/references/process-model.md` for the conceptual model.
- `/Users/mikhail/Projects/Context-Engineering/Distil/rlm-ralph-loop-multi-agent-orchestration/references/ulcb1-tree-search.md` for recursive control and stopping conditions.
